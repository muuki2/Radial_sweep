...
__published:	// IDE-managed Components
	...
	TButton *ButtonVidljiveDuzi;
bool je_vidljiva(const Tacka&, const Duz&, const set<const Duz*, DuziPoY>&);
	bool duzi_se_sijeku(const Duz&, const Duz&);
    bool tacka_na_duzi(const Tacka&, const Tacka&, const Tacka&);
	...
	void __fastcall ButtonVidljiveDuziClick(TObject *Sender);
